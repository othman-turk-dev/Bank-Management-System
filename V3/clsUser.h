...
private:
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        vector <string> LoginRegisterDataLine = clsMyString::Split(Line, Seperator);
    ...
    static clsUser _ConvertLinetoUserObject(string Line, string Seperator = "#//#")
    {
        ...
        vUserData = clsMyString::Split(Line, Seperator);

        return clsUser(enMode::UpdateMode, vUserData[0], vUserData[1], vUserData[2],
            vUserData[3], vUserData[4], clsUtility::DecryptText(vUserData[5]), stoi(vUserData[6]));
    ...
    {
        return clsUtility::EncryptText(Password);
    }
